...
const handleClickBetalen = async () => {
	const res = await fetch(
		`${process.env.NEXT_PUBLIC_API_URL}/save-appointment`,
		{
			method: "POST",
					...
					<div className="p-5 width-[600px] height-[780px] ml-[40%] ">
						...
						<div className="relative top-[50px] absolute space-y-8">
							...
							<div className="h-[200px] space-y-10 space-x-10">
								<button className="h-[100px] w-[100px] font-bold">
									<img src="https://www.ideal.nl/img/logo/ideal-logo-1024.png"></img>
									iDeal
								</button>
								<button className="h-[100px] w-[100px] font-bold">
									<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Apple_Pay_logo.svg/1200px-Apple_Pay_logo.svg.png"></img>
									Apple Pay
								</button>
								<button className="h-[100px] w-[100px] font-bold">
									<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Google_Pay_Logo.svg/2560px-Google_Pay_Logo.svg.png"></img>
									Google Pay
								</button>
								<button className="h-[100px] w-[100px] font-bold">
									<img src="https://media.istockphoto.com/id/1215256045/vector/safe-payment-logo-template-designs-vector-illustration.jpg?s=612x612&w=0&k=20&c=22EA9Y3-gToqirb3PlgCqjnoprrgXyPAvO4_CZmT2Jc="></img>
									Credit Card
								</button>
								<button className="h-[100px] w-[100px] font-bold">
									<img src="https://www.paypalobjects.com/webstatic/mktg/logo-center/PP_Acceptance_Marks_for_LogoCenter_266x142.png"></img>
									Paypal
								</button>
							</div>
							<div className="relative top-[120px]">
								...
								<div className="">
									<label className="">
										<input
											className="relative right-[] text-right"
											type="checkbox"
										/>
										<span className="p-2">
											studentenkorting toevoegen
										</span>
									</label>
								</div>
