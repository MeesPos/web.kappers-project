...
function Betalen1(){
  ...
  <div className="w-[1200px] h-[800px] rounded-3xl m-auto p-5 bg-white">
    <div className="float-left p-2 bg-white text-center w-[440px] h-[700px] items-center">
      ...
      <h1 className="relative top-[125px] text-indigo-500 text-2xl font-bold p-2">Betalen</h1>
    ...
    <div className="p-5 width-[600px] height-[780px] ml-[40%] ">
      <h1 className="text-indigo-500 font-bold text-2xl">
        ...
        <div className="relative top-[50px] absolute space-y-8">
            <h3 className="text-2xl font-bold text-indigo-500">Betaalmethode selecteren</h3>
          ...
          <div className="relative top-[120px]">
            <h4 className="text-base text-black font-bold">Student?</h4>
            <div className="">
            <label className="">
            <input className="relative right-[] text-right" type="checkbox" />
            <span className="p-2">studentenkorting toevoegen</span>
            </label>
            </div>
            <h4 className="relative top-[100px] text-base text-black">Totaal: €19,49</h4>
          <div>
           </div>
          </div>
        </div>
        ...
        <div className="relative text-black text-xl top-[225px] left-[-50px]">
          <button className="relative w-24 text-sm float-right bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded"
