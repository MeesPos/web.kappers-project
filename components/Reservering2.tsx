...
function Reservering2(){
  ...
  <div className="w-[1200px] h-[800px] rounded-3xl m-auto p-5 z-50 bg-white absolute top-0 left-1/4">
    <div className="float-left p-2 bg-white text-center w-[440px] h-[700px] items-center">
      <img className="relative top-[30px] ml-[40%]" src="fotos/Group1.png" width="80px" />
      <h1 className="relative top-[125px] text-indigo-500 text-2xl font-bold p-2">Selecteer behandeling</h1>
      ...
      <h1 className="text-indigo-500 font-bold text-2xl font-bold">
        ...
        <div className="absolute space-y-8">
          ...
          <div className="width-[650px]">
            <button id="tweedeKapper" value="tweedegekozenkapper" className="w-[650px] hover:border-2" type="button"
          ...
          <div className="width-[650px]">
            <button className="w-[650px] hover:border-2" type="button" 
