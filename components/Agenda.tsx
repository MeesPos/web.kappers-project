...
//                 <input
//                   id="checkbox1"
//                   className="appearance-none checked:bg-gray-300"
//                   type="checkbox"
//                 />
//                 <label
//                   for="checkbox1"
//                   className="overflow-hidden rounded-lg shadow-md ring ring-transparant peer-checked:ring-blue-500 grayscale peer-checked:grayscale-0 transition-all"
//                 >
//                   1
//                 </label>
//                 <h4 className="">2</h4>
