            ...
            <div>
              ...
              <div className="p-5 divide-y divide-solid divide-gray-200">
                <div className="grid py-5 first:pt-0 last:pb-0 grid-cols-2">
                  <span className="text-md font-light">Datum en tijd</span>
                  <p className="text-black ">
                    {afspraak.date} {afspraak.start_time}-{afspraak.end_time}
                  </p>
                </div>
                <div className="grid py-5 first:pt-0 last:pb-0 grid-cols-2">
                  <span className="text-md font-light">Kapper</span>
                  <p className="text-black ">{afspraak.hairdresser_name}</p>
                </div>
                <div className="grid  py-5 0 grid-cols-2">
                  <span className="text-md font-light">Behandeling</span>
                  <p className="text-black ">
                    {afspraak.treatment.name || afspraak.treatment.id}
                  </p>
                </div>
                <div className="grid py-5 first:pt-0 last:pb-0  grid-cols-2">
                  <span className="text-md font-light">Opmerkingen</span>
                  <p className="text-black -black">
                    {afspraak.personal_data.note}
                  </p>
                </div>
                <div className="grid py-5 first:pt-0 last:pb-0  grid-cols-2">
                  <span className="text-md font-light">Telefoon Nummer</span>
                  <p className="text-black ">
                ...
                <div className="grid py-5 first:pt-0 last:pb-0  grid-cols-2">
                  ...
                  <p className="text-black">{afspraak.personal_data.email}</p>
                </div>
              </div>
            </div>
          </div>
