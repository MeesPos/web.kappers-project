					...
					<div className="p-5 width-[600px] height-[780px] ml-[40%] ">
						...
						<div className="relative top-[50px] absolute space-y-8">
							...
							<div className="relative">
								<h4 className="text-2xl text-indigo-500 font-bold">
									Betaling
								</h4>
								<div className="">
									<br></br>
									<div className="space-y-8">
										...
										<h3 className="w-[550px] text-sm text-gray-500 pt-8">
											Let op als u niet kunt op de
											aangeven datum of toch op een datum
											wilt / kan klik dan op de annuleren
											knop
										</h3>
									</div>
								</div>
						...
						<div className="relative text-black text-xl top-[100px] w-[550px] left-[10px]">
							<button
								className="relative w-24 text-sm bg-red-500 hover:bg-red-700 text-white font-bold py-2 border border-red-700 rounded float-right"
